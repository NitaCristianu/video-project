...
`);
    ...
    const perlin_3d_grid = new PerlinNoise(generator.intArray(256,0, 360));
    ...
    yield* waitUntil("map");
    yield* map().x(-850, 1);
    yield loop(() => updateCam());

    yield* waitUntil("first map");
    yield* main(`\
def getBlockType(x,y,z):
